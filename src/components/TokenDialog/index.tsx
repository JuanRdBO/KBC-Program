...
import { TokenCircle } from "../CustomTokenIcon";
import { useSwappableTokens, useTokenList } from "../../context/tokenList";
...
export function TokenButton({
    ...
    let tokenInfo = tokenMap.filter((t: { address: string; })=>t.address == mint.toBase58())[0];
